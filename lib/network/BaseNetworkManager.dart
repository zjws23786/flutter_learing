...
import 'package:flutter_app/loading/ProgressDialog.dart' as loading;

class BaseNetworkManager {
  static BaseNetworkManager instance;
  static String BASE_URL = "http://api.chebaotec.com/lzapi/lzbusiness/";
  Dio dio;
  BaseOptions options;

  CancelToken cancelToken = CancelToken();

  static BaseNetworkManager getInstance() {
    if (null == instance) instance = BaseNetworkManager();
    return instance;
  }
