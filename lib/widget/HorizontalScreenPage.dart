...
class HorizontalScreenPage extends StatefulWidget {
  HorizontalScreenPage({Key key}) : super(key: key);

  _HorizontalScreenPageState createState() => _HorizontalScreenPageState();
}

class _HorizontalScreenPageState extends State<HorizontalScreenPage> {
  @override
  void initState() {
    // 强制横屏
