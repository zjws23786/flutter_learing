...
class _AppBarWidgetState extends State with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        // 如果没有设置这项， 二级页面 会默认是返回箭头  ，
        //有侧边栏的页面默认有图标（用来打开侧边栏）
        // leading: Icon(Icons.home),

        // 如果有 leading  这个不会管用 ； 如果没有leading ，
        //当有侧边栏的时候， false：不会显示默认的图片，
        //true 会显示 默认图片，并响应打开侧边栏的事件
